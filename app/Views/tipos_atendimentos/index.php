        ...
        tabelaTipos.innerHTML = tipos.map((tipo) => {
            ...
            return `
                <tr>
                    ...
                    <td class="text-end">
                        <button type="button" class="btn btn-sm btn-outline-primary" onclick="editarTipo(${Number(tipo.id)})">
                            Editar
                        </button>
                        <button type="button" class="btn btn-sm btn-outline-danger" onclick="inativarTipo(${Number(tipo.id)})">
                            Inativar
                        </button>
                    </td>
                </tr>
